/* ============================================================
   ФИНАЛЬНОЕ ОБНОВЛЕНИЕ 3.0 — ИСПРАВЛЕННОЕ (с ожиданием)
   ============================================================ */
...
(function() {
    ...
    // Проверяем, что основные объекты уже созданы
    function waitForApp() {
        if (typeof DB === 'undefined' || typeof currentUser === 'undefined' || typeof ROLES === 'undefined') {
            console.log('⏳ Основные данные ещё не загружены, ждём...');
            setTimeout(waitForApp, 200);
            return;
        }

        console.log('✅ Основные данные загружены, запускаем обновление...');
        initUpdate();
    }
    ...
    function initUpdate() {
        ...
        // ============================================================
        // 6. ИНИЦИАЛИЗАЦИЯ (запуск всех функций)
        // ============================================================
