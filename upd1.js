// ==============================================================
//  ОБНОВЛЕНИЕ 1 – Базовое приложение МТО (интерфейс, данные)
//  Версия 1.0.0
...
(function() {
  ...
  // ---------- ДАННЫЕ (полностью из финальной версии) ----------
  const DATA = {
    materials: [
  ...
  // ---------- ГЕНЕРАЦИЯ HTML (основное приложение, без оверлея) ----------
  ...
  // ---------- СОЗДАНИЕ ПРИЛОЖЕНИЯ ПРИ ЗАГРУЗКЕ ----------
  function createApp() {
    let container = document.getElementById(CFG.APP_ID);
    if (!container) {
